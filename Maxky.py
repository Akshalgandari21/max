...
#Khusus Login Token
Galank = LINE('EDVe2QNnBQ7CFLXrrx53.wuylwj4ToT26kXh9NU8+8W.mos4yCFv7gq2UATEDDhVpW7P7QrC99gSV28w+mkEkeE=')
Galank.log("Auth Token : " + str(Galank.authToken))
Galank.log("Timeline Token : " + str(Galank.tl.channelAccessToken))

Galank1 = LINE('EDt5VUpPrFCSfEXA5QBc.4cZCr+vjNC29urMDGBZlpa.wYgrKSsqYzg4bRY2oTQboGP8+354nZbkCu1leuLz2YE=')
Galank1.log("Auth Token : " + str(Galank1.authToken))
Galank1.log("Timeline Token : " + str(Galank1.tl.channelAccessToken))

Galank2 = LINE('EDGBKK1VDpzihxKS8888.BpCKkf3Ju3l/twO2UzdtYa.nfj70TGC1ttoFkyKCm25HuZQwQZt5y6HbNSZP5m16vQ=')
Galank2.log("Auth Token : " + str(Galank2.authToken))
Galank2.log("Timeline Token : " + str(Galank2.tl.channelAccessToken))

Galank3 = LINE('ED1mdiA0JWJR32jlztLd.3/PYls6PbTe/75uJrezv+q.fRA4Oa/3xxaZAgJ1mmb3alKErEczsiYs2iqrsBAV/C8=')
...
admin=["u417afa40ff4bc387410cbc3531ce6853"] 
...
wait = {
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks for add me \n Creator line.me/ti/p/~akshalrg12",
    "lang":"JP",
